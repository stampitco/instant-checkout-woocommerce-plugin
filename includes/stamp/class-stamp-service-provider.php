...
class Stamp_IC_WC_Stamp_Service_Provider extends AbstractServiceProvider {
	...
	public function register() {
		...
		$container->add( 'Stamp_IC_WC_Api_Client' )
		          ->addMethodCall( 'set_api_url', array( STAMP_API_URL ) )
		          ->addMethodCall( 'set_api_token', array( $settings_repository->get( Stamp_IC_WC_Settings_Repository::STAMP_API_KEY ) ) );

...
class Stamp_IC_WC_Admin_Settings {
	...
	public function save_styling() {
		...
		$additional_css = isset( $_POST[ 'stamp_ic_additional_css' ] ) ? wc_clean( $_POST[ 'stamp_ic_additional_css' ] ) : null;

		if( ! is_null( $additional_css ) ) {
			$this->settings_repository->set( Stamp_IC_WC_Settings_Repository::ADDITIONAL_CSS, $additional_css );
		}
